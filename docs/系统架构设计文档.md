...
| ---- | ---- | ---- | ---- | ---- |
| /v1/auth/login | POST | 医生服务 | 用户登录 | 否 |
| /v1/auth/logout | POST | 医生服务 | 用户登出 | 是 |
| /v1/hospital/drugs | GET | 药品服务 | 查询药品列表 | 是 |
| /v1/hospital/drugs/:id | GET | 药品服务 | 查询药品详情 | 是 |
| /v1/hospital/drugs | POST | 药品服务 | 新增药品 | 是（管理员/医生） |
| /v1/hospital/drugs/:id | PUT | 药品服务 | 编辑药品 | 是（管理员/医生） |
| /v1/hospital/drugs/:id/status | PUT | 药品服务 | 更新药品状态 | 是（管理员/医生） |
| /v1/hospital/drugs/:id | DELETE | 药品服务 | 删除药品 | 是（管理员） |
| /v1/hospital/inventory | GET | 库存服务 | 查询库存列表 | 是 |
| /v1/hospital/inventory/:id | GET | 库存服务 | 查询库存详情 | 是 |
| /v1/hospital/inventory | POST | 库存服务 | 药品入库 | 是（药房工作人员） |
| /v1/hospital/inventory/outbound | POST | 库存服务 | 药品出库 | 是（药房工作人员） |
| /v1/hospital/inventory/:id/adjust | POST | 库存服务 | 库存调整 | 是（药房工作人员） |
| /v1/hospital/inventory/:id/freeze | PUT | 库存服务 | 冻结/解冻库存 | 是（管理员） |
| /v1/hospital/inventory/low-stock | GET | 库存服务 | 查询低库存药品 | 是（药房工作人员） |
| /v1/hospital/inventory/expiring | GET | 库存服务 | 查询近效期药品 | 是（药房工作人员） |
| /v1/hospital/patients | GET | 病人服务 | 查询病人列表 | 是 |
| /v1/hospital/patients/:id | GET | 病人服务 | 查询病人详情 | 是 |
| /v1/hospital/patients | POST | 病人服务 | 新增病人 | 是（医生） |
| /v1/hospital/patients/:id | PUT | 病人服务 | 更新病人信息 | 是（医生） |
| /v1/hospital/patients/:id | DELETE | 病人服务 | 删除病人 | 是（管理员） |
| /v1/hospital/prescriptions | GET | 药品服务 | 查询处方列表 | 是 |
| /v1/hospital/prescriptions/:id | GET | 药品服务 | 查询处方详情 | 是 |
| /v1/hospital/prescriptions | POST | 药品服务 | 开具处方 | 是（医生） |
| /v1/hospital/prescriptions/:id/review | PUT | 药品服务 | 处方审核 | 是（药房工作人员） |
| /v1/hospital/prescriptions/:id/dispense | POST | 药品服务 | 发药 | 是（药房工作人员） |
| /v1/hospital/prescriptions/:id/cancel | POST | 药品服务 | 取消处方 | 是（医生/管理员） |
| /v1/hospital/prescriptions/pending-review/:pharmacyId | GET | 药品服务 | 获取待审核处方 | 是（药房工作人员） |
| /v1/hospital/prescriptions/stats | GET | 药品服务 | 获取处方统计 | 是（管理员） |
| /v1/hospital/doctors | GET | 医生服务 | 查询医生列表 | 是（管理员） |
| /v1/hospital/doctors/:id | GET | 医生服务 | 查询医生详情 | 是（管理员/医生） |
| /v1/hospital/doctors | POST | 医生服务 | 新增医生 | 是（管理员） |
| /v1/hospital/doctors/:id | PUT | 医生服务 | 更新医生信息 | 是（管理员） |
| /v1/hospital/doctors/:id/password | PUT | 医生服务 | 更新医生密码 | 是（管理员/医生） |
| /v1/hospital/doctors/:id | DELETE | 医生服务 | 删除医生 | 是（管理员） |
| /v1/hospital/departments | GET | 医院服务 | 查询部门列表 | 是 |
| /v1/hospital/departments/tree | GET | 医院服务 | 查询部门树结构 | 是 |
| /v1/hospital/departments | POST | 医院服务 | 新增部门 | 是（管理员） |
| /v1/hospital/departments/:id | GET | 医院服务 | 查询部门详情 | 是 |
| /v1/hospital/departments/:id | PUT | 医院服务 | 更新部门信息 | 是（管理员） |
| /v1/hospital/departments/:id | DELETE | 医院服务 | 删除部门 | 是（管理员） |
| /v1/system/menus | GET | 系统服务 | 查询菜单列表 | 是（管理员） |
| /v1/system/menus | POST | 系统服务 | 创建菜单 | 是（管理员） |
| /v1/system/menus/:id | GET | 系统服务 | 查询菜单详情 | 是（管理员） |
| /v1/system/menus/:id | PUT | 系统服务 | 更新菜单 | 是（管理员） |
| /v1/system/menus/:id | DELETE | 系统服务 | 删除菜单 | 是（管理员） |
| /v1/system/roles | GET | 系统服务 | 查询角色列表 | 是（管理员） |
| /v1/system/roles | POST | 系统服务 | 创建角色 | 是（管理员） |
| /v1/system/roles/:id | GET | 系统服务 | 查询角色详情 | 是（管理员） |
| /v1/system/roles/:id | PUT | 系统服务 | 更新角色 | 是（管理员） |
| /v1/system/roles/:id | DELETE | 系统服务 | 删除角色 | 是（管理员） |
| /v1/system/users | GET | 系统服务 | 查询用户列表 | 是（管理员） |
| /v1/system/users | POST | 系统服务 | 创建用户 | 是（管理员） |
| /v1/system/users/:id | GET | 系统服务 | 查询用户详情 | 是（管理员） |
| /v1/system/users/:id | PUT | 系统服务 | 更新用户 | 是（管理员） |
| /v1/system/users/:id | DELETE | 系统服务 | 删除用户 | 是（管理员） |
| /v1/system/users/:id/password | POST | 系统服务 | 更新用户密码 | 是（管理员） |

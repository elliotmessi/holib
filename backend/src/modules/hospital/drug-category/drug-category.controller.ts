...
export class DrugCategoryController {
  ...
  @ApiResult({ type: [DrugCategoryEntity], isPage: true })
  @Perm(permissions.LIST)
  async list(@Query() query: DrugCategoryQueryDto): Promise<Pagination<DrugCategoryEntity>> {
  ...
  async update(@Param("id") id: number, @Body(UpdaterPipe) updateDto: UpdateDrugCategoryDto): Promise<void> {

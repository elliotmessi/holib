...
export class PatientAllergyController {
  ...
  @ApiResult({ type: [PatientAllergyEntity], isPage: true })
  @Perm(permissions.LIST)
  async list(@Query() query: PatientAllergyQueryDto): Promise<Pagination<PatientAllergyEntity>> {
  ...
  async create(@Body(CreatorPipe) createDto: CreatePatientAllergyDto): Promise<PatientAllergyEntity> {
  ...
  async update(@Param("id") id: number, @Body(UpdaterPipe) updateDto: UpdatePatientAllergyDto): Promise<void> {

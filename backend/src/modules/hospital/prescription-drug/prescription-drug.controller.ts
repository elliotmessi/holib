...
import { CreatePrescriptionDrugDto, UpdatePrescriptionDrugDto, PrescriptionDrugQueryDto } from "./prescription-drug.dto"
...
export class PrescriptionDrugController {
  ...
  @ApiResult({ type: [PrescriptionDrugEntity], isPage: true })
  @Perm(permissions.LIST)
  async list(@Query() query: PrescriptionDrugQueryDto): Promise<Pagination<PrescriptionDrugEntity>> {
  ...
  @Perm(permissions.LIST)
  async getByPrescription(@Param("prescriptionId") prescriptionId: number): Promise<PrescriptionDrugEntity[]> {
  ...
  async create(@Body(CreatorPipe) createDto: CreatePrescriptionDrugDto): Promise<PrescriptionDrugEntity> {
  ...
  async update(@Param("id") id: number, @Body(UpdaterPipe) updateDto: UpdatePrescriptionDrugDto): Promise<void> {

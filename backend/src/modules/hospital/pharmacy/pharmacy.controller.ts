...
export class PharmacyController {
  ...
  @ApiResult({ type: [PharmacyEntity], isPage: true })
  @Perm(permissions.LIST)
  async list(@Query() query: PharmacyQueryDto): Promise<Pagination<PharmacyEntity>> {
  ...
  async update(@Param("id") id: number, @Body(UpdaterPipe) updateDto: UpdatePharmacyDto): Promise<void> {

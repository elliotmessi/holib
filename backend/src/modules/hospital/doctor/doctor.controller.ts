...
export class DoctorController {
  ...
  @ApiResult({ type: [DoctorEntity], isPage: true })
  @Perm(permissions.LIST)
  async list(@Query() query: DoctorQueryDto): Promise<Pagination<DoctorEntity>> {
  ...
  async update(@Param("id") id: number, @Body(UpdaterPipe) updateDto: UpdateDoctorDto): Promise<void> {

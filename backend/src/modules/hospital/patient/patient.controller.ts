...
export class PatientController {
  ...
  @ApiResult({ type: [PatientEntity], isPage: true })
  @Perm(permissions.LIST)
  async list(@Query() query: PatientQueryDto): Promise<Pagination<PatientEntity>> {
  ...
  async getByMedicalRecordNumber(@Param("medicalRecordNumber") medicalRecordNumber: string): Promise<PatientEntity> {
  ...
  async update(@Param("id") id: number, @Body(UpdaterPipe) updateDto: UpdatePatientDto): Promise<void> {
  ...
  @Perm(permissions.UPDATE)
  async updateDiagnosis(@Param("id") id: number, @Body("diagnosis") diagnosis: string): Promise<void> {
  ...
  @Perm(permissions.UPDATE)
  async updateAllergyHistory(@Param("id") id: number, @Body("allergyHistory") allergyHistory: string): Promise<void> {

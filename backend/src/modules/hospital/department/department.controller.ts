...
export class DepartmentController {
  ...
  @ApiResult({ type: [DepartmentEntity], isPage: true })
  @Perm(permissions.LIST)
  async list(@Query() query: DepartmentQueryDto): Promise<Pagination<DepartmentEntity>> {
  ...
  async update(@Param("id") id: number, @Body(UpdaterPipe) updateDto: UpdateDepartmentDto): Promise<void> {

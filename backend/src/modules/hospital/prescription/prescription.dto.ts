...
import { IsString, IsOptional, IsInt, Min, MinLength, IsNumber, IsEnum, IsArray, ValidateNested, MaxLength } from "class-validator"
...
export class PrescriptionQueryDto extends PagerDto {
